    ...
    <section className="relative pt-32 pb-24 px-4 md:px-12 overflow-hidden flex-grow flex flex-col justify-center">
      ...
      <div className="max-w-[var(--spacing-container-max)] mx-auto text-center relative z-10 w-full mt-10">
        <AnimateOnScroll delay="0">
          <h1 className="font-display-lg text-4xl md:text-display-lg text-ld-on-background font-bold max-w-4xl mx-auto mb-6 leading-tight">
            Dites adieu aux factures sur Word et Excel
          </h1>
          <p className="font-body-lg text-body-lg text-ld-secondary max-w-2xl mx-auto mb-10 text-xl">
            La solution de facturation simple et moderne pour les entrepreneurs africains.
          </p>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll delay="200" className="relative mx-auto max-w-5xl rounded-[2rem] shadow-float bg-white border border-ld-outline-variant/20 p-2 md:p-4 overflow-hidden group">
